...
public class C2DMRegistrationReceiver extends BroadcastReceiver {
	...
	private void saveRegistrationId(Context context, String registrationId) {
		...
		edit.putString(EnthusiaActivity.AUTH, registrationId);
		edit.commit();
	}

	public void createNotification(Context context, String registrationId) {
		NotificationManager notificationManager = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
		Notification notification = new Notification(R.drawable.ic_launcher,registrationId, System.currentTimeMillis());
		...
		notification.setLatestEventInfo(context, "Registration",registrationId, pendingIntent);
